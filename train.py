...
os.environ["WANDB_API_KEY"] ='7fc93e0931446c2ce1f3ebafea23e1d2e2d520b1'
...
#            每隔一定轮数进行验证
            if epoch % setting['eval_freq'] == 0:
                ...
                # #记录验证PSNR到wandb
                wandb.log({'valid_psnr': avg_psnr}, step=epoch)
                ...
                # 记录最佳PSNR到wandb
                wandb.log({'best_psnr': best_psnr}, step=epoch)
            #torch.save({'state_dict': network.state_dict()},
